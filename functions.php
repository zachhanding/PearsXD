...
function pears_meta_box( $post ) {
    ...
    echo '<label for="javascript">JAVASCRIPT</label>	';
  	echo '<p><textarea id="javascript" name="javascript" rows="20" cols="90" />' . $javascript . '</textarea></p>';
}
...
function pears_save_post( $post_id ) {
    ...
    $javascript_data = $_POST['javascript'];
	update_post_meta($post_id, 'javascript', $javascript_data);
}